...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    1045:	68 38 1a 00 00       	push   $0x1a38
...
ls(char *path)
{
  ...
  case T_FILE:
    ...
    1177:	6a 02                	push   $0x2
    1179:	50                   	push   %eax
    117a:	68 18 1a 00 00       	push   $0x1a18
    117f:	6a 01                	push   $0x1
    1181:	e8 4a 05 00 00       	call   16d0 <printf>
    break;
  ...
  case T_DIR:
    ...
    *p++ = '/';
    ...
    12a7:	50                   	push   %eax
    12a8:	68 18 1a 00 00       	push   $0x1a18
    12ad:	6a 01                	push   $0x1
    12af:	e8 1c 04 00 00       	call   16d0 <printf>
  ...
  if((fd = open(path, 0)) < 0){
    ...
    12c3:	57                   	push   %edi
    12c4:	68 f0 19 00 00       	push   $0x19f0
    12c9:	6a 02                	push   $0x2
    12cb:	e8 00 04 00 00       	call   16d0 <printf>
    return;
  ...
  case T_DIR:
    ...
    12e3:	68 25 1a 00 00       	push   $0x1a25
    12e8:	6a 01                	push   $0x1
    12ea:	e8 e1 03 00 00       	call   16d0 <printf>
      break;
  ...
  if(fstat(fd, &st) < 0){
    ...
    1303:	57                   	push   %edi
    1304:	68 04 1a 00 00       	push   $0x1a04
    1309:	6a 02                	push   $0x2
    130b:	e8 c0 03 00 00       	call   16d0 <printf>
    close(fd);
    ...
    1329:	50                   	push   %eax
    132a:	68 04 1a 00 00       	push   $0x1a04
    132f:	6a 01                	push   $0x1
    1331:	e8 9a 03 00 00       	call   16d0 <printf>
        continue;
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    1634:	56                   	push   %esi
    1635:	53                   	push   %ebx
    1636:	89 c6                	mov    %eax,%esi
    1638:	83 ec 3c             	sub    $0x3c,%esp
  char buf[16];
  int i, neg;
  uint x;
  ...
  if(sgn && xx < 0){
    ...
    1640:	74 7e                	je     16c0 <printint+0x90>
    1642:	89 d0                	mov    %edx,%eax
    1644:	c1 e8 1f             	shr    $0x1f,%eax
    1647:	84 c0                	test   %al,%al
    1649:	74 75                	je     16c0 <printint+0x90>
    neg = 1;
    x = -xx;
    164b:	89 d0                	mov    %edx,%eax
  int i, neg;
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    164d:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
    x = -xx;
    1654:	f7 d8                	neg    %eax
    1656:	89 75 c0             	mov    %esi,-0x40(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    1659:	31 ff                	xor    %edi,%edi
    165b:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    165e:	89 ce                	mov    %ecx,%esi
    1660:	eb 08                	jmp    166a <printint+0x3a>
    1662:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1668:	89 cf                	mov    %ecx,%edi
    166a:	31 d2                	xor    %edx,%edx
    166c:	8d 4f 01             	lea    0x1(%edi),%ecx
    166f:	f7 f6                	div    %esi
    1671:	0f b6 92 44 1a 00 00 	movzbl 0x1a44(%edx),%edx
  }while((x /= base) != 0);
  ...
  do{
    buf[i++] = digits[x % base];
    167a:	88 14 0b             	mov    %dl,(%ebx,%ecx,1)
  }while((x /= base) != 0);
    167d:	75 e9                	jne    1668 <printint+0x38>
  if(neg)
    167f:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1682:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1685:	85 c0                	test   %eax,%eax
    1687:	74 08                	je     1691 <printint+0x61>
    buf[i++] = '-';
    1689:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
    168e:	8d 4f 02             	lea    0x2(%edi),%ecx
    1691:	8d 7c 0d d7          	lea    -0x29(%ebp,%ecx,1),%edi
    1695:	8d 76 00             	lea    0x0(%esi),%esi
    1698:	0f b6 07             	movzbl (%edi),%eax
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    169e:	83 ef 01             	sub    $0x1,%edi
    16a1:	6a 01                	push   $0x1
    16a3:	53                   	push   %ebx
    16a4:	56                   	push   %esi
    16a5:	88 45 d7             	mov    %al,-0x29(%ebp)
    16a8:	e8 f5 fe ff ff       	call   15a2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    16b0:	39 df                	cmp    %ebx,%edi
    16b2:	75 e4                	jne    1698 <printint+0x68>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
    16c2:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    16c9:	eb 8b                	jmp    1656 <printint+0x26>
    16cb:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    16d6:	8d 45 10             	lea    0x10(%ebp),%eax
}
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    16e2:	89 45 d0             	mov    %eax,-0x30(%ebp)
    16e5:	0f b6 1e             	movzbl (%esi),%ebx
    16e8:	83 c6 01             	add    $0x1,%esi
    16eb:	84 db                	test   %bl,%bl
    16ed:	0f 84 b0 00 00 00    	je     17a3 <printf+0xd3>
    16f3:	31 d2                	xor    %edx,%edx
    16f5:	eb 39                	jmp    1730 <printf+0x60>
    16f7:	89 f6                	mov    %esi,%esi
    16f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    1700:	83 f8 25             	cmp    $0x25,%eax
    1703:	89 55 d4             	mov    %edx,-0x2c(%ebp)
        state = '%';
    1706:	ba 25 00 00 00       	mov    $0x25,%edx
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    170b:	74 18                	je     1725 <printf+0x55>
#include "user.h"
...
{
  write(fd, &c, 1);
    170d:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    1710:	83 ec 04             	sub    $0x4,%esp
    1713:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    1716:	6a 01                	push   $0x1
    1718:	50                   	push   %eax
    1719:	57                   	push   %edi
    171a:	e8 83 fe ff ff       	call   15a2 <write>
    171f:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1722:	83 c4 10             	add    $0x10,%esp
    1725:	83 c6 01             	add    $0x1,%esi
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1728:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    172c:	84 db                	test   %bl,%bl
    172e:	74 73                	je     17a3 <printf+0xd3>
    c = fmt[i] & 0xff;
    if(state == 0){
    1730:	85 d2                	test   %edx,%edx
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    1732:	0f be cb             	movsbl %bl,%ecx
    1735:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1738:	74 c6                	je     1700 <printf+0x30>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
    ...
    173a:	83 fa 25             	cmp    $0x25,%edx
    173d:	75 e6                	jne    1725 <printf+0x55>
      if(c == 'd'){
    173f:	83 f8 64             	cmp    $0x64,%eax
    1742:	0f 84 f8 00 00 00    	je     1840 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1748:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    174e:	83 f9 70             	cmp    $0x70,%ecx
    1751:	74 5d                	je     17b0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1753:	83 f8 73             	cmp    $0x73,%eax
    1756:	0f 84 84 00 00 00    	je     17e0 <printf+0x110>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    175c:	83 f8 63             	cmp    $0x63,%eax
    175f:	0f 84 ea 00 00 00    	je     184f <printf+0x17f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1765:	83 f8 25             	cmp    $0x25,%eax
    1768:	0f 84 c2 00 00 00    	je     1830 <printf+0x160>
#include "user.h"
...
{
  write(fd, &c, 1);
    176e:	8d 45 e7             	lea    -0x19(%ebp),%eax
    1771:	83 ec 04             	sub    $0x4,%esp
    1774:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    1778:	6a 01                	push   $0x1
    177a:	50                   	push   %eax
    177b:	57                   	push   %edi
    177c:	e8 21 fe ff ff       	call   15a2 <write>
    1781:	83 c4 0c             	add    $0xc,%esp
    1784:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    1787:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    178a:	6a 01                	push   $0x1
    178c:	50                   	push   %eax
    178d:	57                   	push   %edi
    178e:	83 c6 01             	add    $0x1,%esi
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1796:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
#include "user.h"
...
putc(int fd, char c)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    179f:	84 db                	test   %bl,%bl
    17a1:	75 8d                	jne    1730 <printf+0x60>
        putc(fd, c);
      }
      state = 0;
    }
    ...
    17b8:	6a 00                	push   $0x0
    17ba:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    17bd:	89 f8                	mov    %edi,%eax
    17bf:	8b 13                	mov    (%ebx),%edx
    17c1:	e8 6a fe ff ff       	call   1630 <printint>
        ap++;
    ...
    17cb:	31 d2                	xor    %edx,%edx
      if(c == 'd'){
        ...
        printint(fd, *ap, 16, 0);
        ap++;
    17cd:	83 c0 04             	add    $0x4,%eax
    17d0:	89 45 d0             	mov    %eax,-0x30(%ebp)
    17d3:	e9 4d ff ff ff       	jmp    1725 <printf+0x55>
    17d8:	90                   	nop
    17d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
    17e0:	8b 45 d0             	mov    -0x30(%ebp),%eax
    17e3:	8b 18                	mov    (%eax),%ebx
        ap++;
    17e5:	83 c0 04             	add    $0x4,%eax
    17e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    17eb:	b8 3a 1a 00 00       	mov    $0x1a3a,%eax
    17f0:	85 db                	test   %ebx,%ebx
    17f2:	0f 44 d8             	cmove  %eax,%ebx
        while(*s != 0){
    17f5:	0f b6 03             	movzbl (%ebx),%eax
    17f8:	84 c0                	test   %al,%al
    17fa:	74 23                	je     181f <printf+0x14f>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    180e:	50                   	push   %eax
    180f:	57                   	push   %edi
    1810:	e8 8d fd ff ff       	call   15a2 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    1815:	0f b6 03             	movzbl (%ebx),%eax
    1818:	83 c4 10             	add    $0x10,%esp
    181b:	84 c0                	test   %al,%al
    181d:	75 e1                	jne    1800 <printf+0x130>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    ...
    1821:	e9 ff fe ff ff       	jmp    1725 <printf+0x55>
    1826:	8d 76 00             	lea    0x0(%esi),%esi
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    1833:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    1836:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    1839:	6a 01                	push   $0x1
    183b:	e9 4c ff ff ff       	jmp    178c <printf+0xbc>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    ...
    1848:	6a 01                	push   $0x1
    184a:	e9 6b ff ff ff       	jmp    17ba <printf+0xea>
    184f:	8b 5d d0             	mov    -0x30(%ebp),%ebx
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    1855:	8b 03                	mov    (%ebx),%eax
    1857:	6a 01                	push   $0x1
    1859:	88 45 e4             	mov    %al,-0x1c(%ebp)
    185c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    185f:	50                   	push   %eax
    1860:	57                   	push   %edi
    1861:	e8 3c fd ff ff       	call   15a2 <write>
    1866:	e9 5b ff ff ff       	jmp    17c6 <printf+0xf6>
    186b:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
    ...
    1879:	56                   	push   %esi
    187a:	53                   	push   %ebx
    187b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    187e:	8b 10                	mov    (%eax),%edx
void
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
    1880:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1883:	39 c8                	cmp    %ecx,%eax
    1885:	73 19                	jae    18a0 <free+0x30>
    1887:	89 f6                	mov    %esi,%esi
    1889:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    1890:	39 d1                	cmp    %edx,%ecx
    1892:	72 1c                	jb     18b0 <free+0x40>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1894:	39 d0                	cmp    %edx,%eax
    1896:	73 18                	jae    18b0 <free+0x40>
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    189a:	39 c8                	cmp    %ecx,%eax
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    189c:	8b 10                	mov    (%eax),%edx
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    189e:	72 f0                	jb     1890 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    18a0:	39 d0                	cmp    %edx,%eax
    18a2:	72 f4                	jb     1898 <free+0x28>
    18a4:	39 d1                	cmp    %edx,%ecx
    18a6:	73 f0                	jae    1898 <free+0x28>
    18a8:	90                   	nop
    18a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      break;
  if(bp + bp->s.size == p->s.ptr){
    18b0:	8b 73 fc             	mov    -0x4(%ebx),%esi
    18b3:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    18b6:	39 d7                	cmp    %edx,%edi
    18b8:	74 19                	je     18d3 <free+0x63>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    18ba:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    18bd:	8b 50 04             	mov    0x4(%eax),%edx
    18c0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    18c3:	39 f1                	cmp    %esi,%ecx
    18c5:	74 23                	je     18ea <free+0x7a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    18d3:	03 72 04             	add    0x4(%edx),%esi
    18d6:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    18d9:	8b 10                	mov    (%eax),%edx
    18db:	8b 12                	mov    (%edx),%edx
    18dd:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    18e0:	8b 50 04             	mov    0x4(%eax),%edx
    18e3:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    18e6:	39 f1                	cmp    %esi,%ecx
    18e8:	75 dd                	jne    18c7 <free+0x57>
    p->s.size += bp->s.size;
    18ea:	03 53 fc             	add    -0x4(%ebx),%edx
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
  ...
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    18f2:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    18f5:	8b 53 f8             	mov    -0x8(%ebx),%edx
    18f8:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1912:	8d 78 07             	lea    0x7(%eax),%edi
    1915:	c1 ef 03             	shr    $0x3,%edi
    1918:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    191b:	85 d2                	test   %edx,%edx
    191d:	0f 84 a3 00 00 00    	je     19c6 <malloc+0xc6>
    1923:	8b 02                	mov    (%edx),%eax
    1925:	8b 48 04             	mov    0x4(%eax),%ecx
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    1928:	39 cf                	cmp    %ecx,%edi
    192a:	76 74                	jbe    19a0 <malloc+0xa0>
    192c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    1932:	be 00 10 00 00       	mov    $0x1000,%esi
    1937:	8d 1c fd 00 00 00 00 	lea    0x0(,%edi,8),%ebx
    193e:	0f 43 f7             	cmovae %edi,%esi
    1941:	ba 00 80 00 00       	mov    $0x8000,%edx
    1946:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
    194c:	0f 46 da             	cmovbe %edx,%ebx
    194f:	eb 10                	jmp    1961 <malloc+0x61>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1958:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    195a:	8b 48 04             	mov    0x4(%eax),%ecx
    195d:	39 cf                	cmp    %ecx,%edi
    195f:	76 3f                	jbe    19a0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    196e:	53                   	push   %ebx
    196f:	e8 96 fc ff ff       	call   160a <sbrk>
  if(p == (char*)-1)
    1974:	83 c4 10             	add    $0x10,%esp
    1977:	83 f8 ff             	cmp    $0xffffffff,%eax
    197a:	74 1c                	je     1998 <malloc+0x98>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    197c:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
  ...
  return freep;
    ...
    1994:	85 d2                	test   %edx,%edx
    1996:	75 c0                	jne    1958 <malloc+0x58>
        return 0;
    1998:	31 c0                	xor    %eax,%eax
    199a:	eb 1c                	jmp    19b8 <malloc+0xb8>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    19a0:	39 cf                	cmp    %ecx,%edi
    19a2:	74 1c                	je     19c0 <malloc+0xc0>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    19a4:	29 f9                	sub    %edi,%ecx
    19a6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    19a9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    19c4:	eb e9                	jmp    19af <malloc+0xaf>
  Header *p, *prevp;
  uint nunits;
