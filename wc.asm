...
wc(int fd, char *name)
{
  ...
  f0:	74 3a                	je     12c <wc+0x8c>
      c++;
      if(buf[i] == '\n')
  f2:	0f be 87 80 1b 00 00 	movsbl 0x1b80(%edi),%eax
        l++;
...
free(void *ap)
{
 ...
 6b1:	a1 60 1b 00 00       	mov    0x1b60,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 707:	89 08                	mov    %ecx,(%eax)
  freep = p;
 709:	a3 60 1b 00 00       	mov    %eax,0x1b60
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 72d:	a3 60 1b 00 00       	mov    %eax,0x1b60
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 60 1b 00 00    	mov    0x1b60,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 79f:	76 3f                	jbe    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	39 05 60 1b 00 00    	cmp    %eax,0x1b60
 ...
 7c6:	e8 e5 fe ff ff       	call   6b0 <free>
  return freep;
 7cb:	8b 15 60 1b 00 00    	mov    0x1b60,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ef:	89 15 60 1b 00 00    	mov    %edx,0x1b60
      return (void*)(p + 1);
 ...
 804:	eb e9                	jmp    7ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 806:	c7 05 60 1b 00 00 64 	movl   $0x1b64,0x1b60
 80d:	1b 00 00 
 810:	c7 05 64 1b 00 00 64 	movl   $0x1b64,0x1b64
 817:	1b 00 00 
    base.s.size = 0;
 81a:	b8 64 1b 00 00       	mov    $0x1b64,%eax
 81f:	c7 05 68 1b 00 00 00 	movl   $0x0,0x1b68
 826:	00 00 00 
