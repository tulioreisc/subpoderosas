...
80100b38:	e8 63 5e 00 00       	call   801069a0 <loaduvm>
...
80100b9f:	e8 bc 5e 00 00       	call   80106a60 <allocuvm>
...
80100bb6:	e8 d5 5f 00 00       	call   80106b90 <freevm>
...
80100bd0:	68 41 6f 10 80       	push   $0x80106f41
...
80100bfb:	e8 b0 60 00 00       	call   80106cb0 <clearpteu>
  sp = sz;
...
80100c29:	e8 22 3a 00 00       	call   80104650 <strlen>
...
80100c3c:	e8 0f 3a 00 00       	call   80104650 <strlen>
...
80100c4d:	e8 be 61 00 00       	call   80106e10 <copyout>
...
80100cb1:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cb7:	e8 54 61 00 00       	call   80106e10 <copyout>
...
80100cfc:	e8 0f 39 00 00       	call   80104610 <safestrcpy>
...
80100d28:	e8 e3 5a 00 00       	call   80106810 <switchuvm>
  freevm(oldpgdir);
80100d2d:	89 3c 24             	mov    %edi,(%esp)
80100d30:	e8 5b 5e 00 00       	call   80106b90 <freevm>
  return 0;
...
80100d71:	e8 2a 35 00 00       	call   801042a0 <acquire>
...
80100da1:	e8 1a 36 00 00       	call   801043c0 <release>
      return f;
...
80100db8:	e8 03 36 00 00       	call   801043c0 <release>
  return 0;
...
80100ddf:	e8 bc 34 00 00       	call   801042a0 <acquire>
  if(f->ref < 1)
...
80100dfc:	e8 bf 35 00 00       	call   801043c0 <release>
  return f;
}
...
80100e31:	e8 6a 34 00 00       	call   801042a0 <acquire>
  if(f->ref < 1)
...
80100e5b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e5c:	e9 5f 35 00 00       	jmp    801043c0 <release>
...
80100e85:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e88:	e8 33 35 00 00       	call   801043c0 <release>
...
801010d4:	68 6f 6f 10 80       	push   $0x80106f6f
...
801010e1:	68 75 6f 10 80       	push   $0x80106f75
...
80101192:	68 7f 6f 10 80       	push   $0x80106f7f
...
801011d5:	e8 36 32 00 00       	call   80104410 <memset>
  log_write(bp);
...
8010121a:	e8 81 30 00 00       	call   801042a0 <acquire>
...
8010125f:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101262:	e8 59 31 00 00       	call   801043c0 <release>
      return ip;
...
801012af:	e8 0c 31 00 00       	call   801043c0 <release>
...
801012c4:	68 95 6f 10 80       	push   $0x80106f95
...
8010138a:	68 a5 6f 10 80       	push   $0x80106fa5
...
801013c1:	e8 fa 30 00 00       	call   801044c0 <memmove>
  brelse(bp);
...
80101456:	68 b8 6f 10 80       	push   $0x80106fb8
...
8010163f:	e8 5c 2c 00 00       	call   801042a0 <acquire>
  ip->ref++;
...
801017c6:	e8 d5 2a 00 00       	call   801042a0 <acquire>
  ip->ref--;
...
801017f0:	e8 ab 2a 00 00       	call   801042a0 <acquire>
    int r = ip->ref;
...
80101c69:	e8 32 26 00 00       	call   801042a0 <acquire>
  ip->ref++;
...
80101cdf:	e8 dc 27 00 00       	call   801044c0 <memmove>
...
80101d6c:	e8 4f 27 00 00       	call   801044c0 <memmove>
    name[len] = 0;
...
801048ae:	e8 dd d2 ff ff       	call   80101b90 <dirlookup>
...
801048c0:	e8 2b d0 ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
801048c5:	89 1c 24             	mov    %ebx,(%esp)
801048c8:	e8 93 cd ff ff       	call   80101660 <ilock>
...
801069a6:	31 db                	xor    %ebx,%ebx
801069a8:	83 ec 1c             	sub    $0x1c,%esp
  uint i, pa, n;
  pte_t *pte;
...
801069ab:	8b 75 18             	mov    0x18(%ebp),%esi
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte); 

    if ((flags & ELF_PROG_FLAG_WRITE) == 0) {
801069ae:	8b 45 1c             	mov    0x1c(%ebp),%eax
801069b1:	83 e0 02             	and    $0x2,%eax
  uint i, pa, n;
  pte_t *pte;
...
801069b6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  //if((uint) addr % PGSIZE != 0)
    //panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801069b9:	75 16                	jne    801069d1 <loaduvm+0x31>
801069bb:	e9 88 00 00 00       	jmp    80106a48 <loaduvm+0xa8>
801069c0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069c6:	81 ee 00 10 00 00    	sub    $0x1000,%esi
801069cc:	39 5d 18             	cmp    %ebx,0x18(%ebp)
801069cf:	76 77                	jbe    80106a48 <loaduvm+0xa8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801069d1:	8b 55 0c             	mov    0xc(%ebp),%edx
801069d4:	8b 45 08             	mov    0x8(%ebp),%eax
801069d7:	31 c9                	xor    %ecx,%ecx
801069d9:	01 da                	add    %ebx,%edx
801069db:	e8 60 fb ff ff       	call   80106540 <walkpgdir>
801069e0:	85 c0                	test   %eax,%eax
801069e2:	74 6e                	je     80106a52 <loaduvm+0xb2>
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte); 
801069e4:	8b 10                	mov    (%eax),%edx

    if ((flags & ELF_PROG_FLAG_WRITE) == 0) {
801069e6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  //if((uint) addr % PGSIZE != 0)
    //panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
801069eb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
    ...
    if ((flags & ELF_PROG_FLAG_WRITE) == 0) {
801069f1:	85 ff                	test   %edi,%edi
801069f3:	75 05                	jne    801069fa <loaduvm+0x5a>
      *pte &= ~PTE_W;
801069f5:	83 e2 fd             	and    $0xfffffffd,%edx
801069f8:	89 10                	mov    %edx,(%eax)
...
801069fa:	8b 45 14             	mov    0x14(%ebp),%eax
    if ((flags & ELF_PROG_FLAG_WRITE) == 0) {
      *pte &= ~PTE_W;
    }
    ...
    if(sz - i < PGSIZE)
801069fd:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106a03:	bf 00 10 00 00       	mov    $0x1000,%edi
80106a08:	0f 46 fe             	cmovbe %esi,%edi
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n) {
80106a0b:	57                   	push   %edi
80106a0c:	01 d8                	add    %ebx,%eax
80106a0e:	50                   	push   %eax
80106a0f:	8d 81 00 00 00 80    	lea    -0x80000000(%ecx),%eax
80106a15:	50                   	push   %eax
80106a16:	ff 75 10             	pushl  0x10(%ebp)
80106a19:	e8 22 af ff ff       	call   80101940 <readi>
80106a1e:	83 c4 10             	add    $0x10,%esp
80106a21:	39 c7                	cmp    %eax,%edi
80106a23:	74 9b                	je     801069c0 <loaduvm+0x20>
      cprintf("loaduvm: Error loading to memory");
80106a25:	83 ec 0c             	sub    $0xc,%esp
80106a28:	68 88 78 10 80       	push   $0x80107888
...
80106a55:	68 e7 77 10 80       	push   $0x801077e7
